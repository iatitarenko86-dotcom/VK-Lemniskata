...
Пример:
Смешали 200 г 10% раствора и 300 г 20% раствора.
...
m₂·c₂ = 300 × 0,2 = 60 г
m = 200 + 300 = 500 г
c = (20 + 60) / 500 × 100% = 80 / 500 × 100% = 16%

Ответ: 16%""",

        2: """📖 Урок 2: Смешивание растворов

Алгоритм решения задач на смешивание:
...
Правило креста (диагональная схема):
      a        |c - b|
        \\     /
          c
        /     \\
...
где a и b - концентрации исходных растворов,
c - концентрация смеси.

Пример:
Смешали 30% и 10% растворы, получили 600 г 15% раствора.
Найти массы каждого раствора.
...
Масса 30% раствора: 600 × 1/4 = 150 г
Масса 10% раствора: 600 × 3/4 = 450 г

Ответ: 150 г и 450 г""",

        3: """📖 Урок 3: Сплавы и высушивание

Сплавы - аналогично растворам, только вместо растворов - сплавы,
вместо вещества - металл.

Особенности задач на высушивание:
При высушивании масса сухого вещества не меняется!
Испаряется только вода.

Формула для высушивания:
m₁ × (100% - w₁) = m₂ × (100% - w₂)

где m₁ - начальная масса, w₁ - начальная влажность,
m₂ - конечная масса, w₂ - конечная влажность.

Пример:
Свежие фрукты содержат 80% воды, сушеные - 28%.
Сколько сухих фруктов получится из 288 кг свежих?

Решение:
Сухого вещества в свежих: 288 × (100% - 80%) = 288 × 0,2 = 57,6 кг
В сушеных сухого: 100% - 28% = 72%
Масса сушеных: 57,6 / 0,72 = 80 кг
