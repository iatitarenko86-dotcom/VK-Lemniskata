...
def send_reference_material(vk, user_id):
    ...
    reference_text = (
        ...
        "Типы движения:\n"
        "1. Движение навстречу: v = v₁ + v₂\n"
        "2. Движение в противоположных направлениях: v = v₁ + v₂\n"
        "3. Движение вдогонку: v = v₁ - v₂ (если v₁ > v₂)\n\n"
...
def get_lesson_1_content():
    ...
    return (
        ...
        "v = 180 / 3 = 60 км/ч\n\n"
        "Практические советы:\n"
        "• Всегда приводите единицы измерения к одному виду\n"
        "• Перед решением определите тип движения\n"
        "• Составьте таблицу данных для наглядности"
    )
...
def get_lesson_2_content():
    ...
    return (
        ...
        "Важно: При движении навстречу скорости всегда складываются!"
    )
...
def get_lesson_3_content():
    ...
    return (
        ...
        "Важно: При движении вдогонку из одной точки с разницей во времени, "
        "начальное расстояние равно пути, пройденному первым объектом за это время."
    )
